...
class ModChain:
    ...
    urls = {
        "main":  {
                    "lite": ["commune-api-node-0.communeai.net"],  
                    "archive": ["commune-archive-node-0.communeai.net", "commune-archive-node-1.communeai.net"]
                },
        "test": {
    ...
    def set_network(self, 
        ...
        if url == None:
            url_options = self.urls[self.network].get('archive' if self.archive else 'lite', [])
