          ...
          <div className="relative flex items-center">
            <div className="relative">
              ...
              <input
                ...
                className="bg-white/5 border border-white/10 text-white pl-10 pr-4 py-2 rounded-lg text-base hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:border-green-500/50 transition-all w-64"
              />
            </div>
          </div>
        </div>
