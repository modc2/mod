        ...
        <div className="p-6 font-mono text-green-500">
          ...
          <div className="mb-8 p-4 border border-green-500 rounded">
            ...
            <div className="space-y-4">
              <div>
                <label className="block mb-2 text-green-300">MESSAGE TO SIGN:</label>
                <textarea
                  value={message}
              ...
              {signature && (
                <div>
                  <label className="block mb-2 text-green-300">SIGNATURE OUTPUT:</label>
          ...
          <div className="mb-8 p-4 border border-green-500 rounded">
            ...
            <div className="space-y-4">
              <div>
                <label className="block mb-2 text-green-300">ORIGINAL MESSAGE:</label>
                <textarea
                  value={verifyMessage}
              ...
              <div>
                <label className="block mb-2 text-green-300">SIGNATURE TO VERIFY:</label>
                <textarea
