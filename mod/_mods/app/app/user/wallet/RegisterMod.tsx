...
export const RegisterMod: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      {/* Register Form */}
      <div className="space-y-3 p-4 rounded-lg bg-gradient-to-br from-blue-500/5 border border-blue-500/20">
        <div className="space-y-3">
          <div>
            <label className="text-xs text-blue-500/70 font-mono uppercase">
              Module Name
            </label>
            <input
              type="text"
              ...
              className="w-full mt-1 bg-black/50 border border-blue-500/30 rounded px-3 py-2 text-blue-400 font-mono text-sm placeholder-blue-600/50 focus:outline-none focus:border-blue-500 disabled:opacity-50"
            />
          </div>
          ...
          <button
            ...
            className="w-full py-2 border border-blue-500/50 text-blue-400 hover:bg-blue-500/10 hover:border-blue-500 transition-all rounded font-mono uppercase disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {isLoading ? (
              <>
