...
/** GET  /compute/_api/instances          — list all instances */
/** GET  /compute/_api/instances?name=x   — cost summary for one */
...
/** POST /compute/_api/instances — create / rent / stop / start / destroy / release / ssh */
