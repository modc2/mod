 ...
 * localStorage origin. A neighbouring module can fill the quota, at which point
 * a raw `localStorage.setItem` throws and takes sign-in down with it.
 *
...
// server published under that address — so the sweep below skips it.
export const LOCAL_KEY_STORAGE = "mcp:localkey";
export const TOKEN_STORAGE = "mcp:token";
export const ADDRESS_STORAGE = "mcp:address";
