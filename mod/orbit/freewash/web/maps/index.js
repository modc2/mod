...
// engine as Washington Square is, because Washington Square is one of these too.
//
...
import santamonica from './santamonica.js';

export const MAP_VERSION = 2;
export const USER_KEY = 'freewash.maps.v1';

export const BUILTIN = [washington, kensington, camden, santamonica];
...
export const LANDMARK_KINDS = [
  { k:'fountain',   label:'Fountain (WSP)',      icon:'⛲', r:12 },
  ...
  { k:'garibaldi',  label:'Sword statue',        icon:'🗡', rot:true },
...
export function blankMap(name = 'My map') {
  return {
    ...
    blurb: 'A map made in the freewash editor. Draw the walks, plant the trees, ' +
