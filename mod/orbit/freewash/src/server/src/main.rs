//! freewash-server — the Rust backend for the freewash WebGL game.
//!
...
// Greenwich-Village-flavoured names so the roster reads like the park.
const ADJS: &[&str] = &[
    "Arch", "Village", "Bleecker", "MacDougal", "Fountain", "Sullivan",
    "Thompson", "Waverly", "Greenwich", "Bowery", "Mercer", "Washington",
];
const NOUNS: &[&str] = &[
    "Skater", "Stroller", "Wanderer", "Drummer", "Local", "Busker",
    "Hooper", "Dreamer", "Rambler", "Cruiser", "Dancer", "Pigeon",
];
