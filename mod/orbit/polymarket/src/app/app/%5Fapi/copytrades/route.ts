// /polymarket/_api/copytrades — my fills and my leaders' trades, joined.
//
...
// on-disk feed store (the same bytes the hub's cards and /_api/basket replay
...
//
// Owner-gated with the token the Rust API mints, same as /_api/hub and
// /_api/basket, and it mints itself one for its own calls to the gated API
