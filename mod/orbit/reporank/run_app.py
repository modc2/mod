"""pm2 entrypoint: run the reporank app in the foreground (see Mod.worker)."""
import os
import sys
...
if __name__ == '__main__':
    port = int(os.environ.get('REPORANK_APP_PORT', 50530))
    m.mod('reporank')().serve(port=port, background=False)
