...
One engine, four faces:
    ...
    API      api/api.py on :50750 — FastAPI, mod-protocol auth
    console  app/server.py on :50751 at /eth — plain ES modules, no build step
...
class Mod:
    ...
    def save(self, name: str = None, source: str = None, path: str = None,
             ...
             note: str = None, public: bool = False, token: str = None,
             **kw) -> dict:
