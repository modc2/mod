...
// SKIN selector — the cabinet's DIP-switch panel. The cap on the rail
// carries three chips off the current palette; pressing it drops a hard
// menu of every cabinet, each row wearing its own three. No preview, no
// animation: you flip the switch and the machine is a different machine.
  ...
  return (
    <div ref={wrap} className="relative shrink-0">
      ...
      >
        ...
        {/* Label only from md up — on a phone the three chips already say
            which cabinet you're in, and the rail is out of room. */}
