// pm2 process definitions for the dev module (fork of claude).
//   dev-api : Rust axum job server + privileged module editor on :8820
//   dev-app : Next.js terminal UI on :8823, served under /claude
//
...
const API_PORT = process.env.CLAUDE_API_PORT || "8870";
const APP_PORT = process.env.CLAUDE_APP_PORT || "8871";
