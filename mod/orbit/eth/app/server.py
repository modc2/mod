...
Two jobs and nothing else:
    ...
    /eth/_api/*    reverse-proxied to the API on :50730
...
and say the API is down, which beats not answering.
    ...
    python3 server.py                          # :50731, API at :50730
    python3 server.py --port 8080 --api http://box:50730
"""
import argparse
import os
import sys
...
API = os.environ.get('ETH_API', 'http://127.0.0.1:50730').rstrip('/')
PORT = int(os.environ.get('ETH_APP_PORT', 50731))
