...
INTENTS = [
    {
        ...
        "answer": (
            ...
            "Whether the router will pay a shielded address at all is its "
            "decision, not this module's, and it changes. When it refuses, "
            "bridge_shielded_in reserves nothing and hands back the two-leg "
            "route instead: bridge to a transparent address you own, then "
            "shielded_shield moves it into the pool. That answer is marked "
            "shielded: false, because the first leg is public. Run "
            "bridge_shielded_plan or take a free quote to see which of the two "
