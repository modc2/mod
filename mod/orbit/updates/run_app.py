"""pm2 entrypoint for the updates web app (background worker).
...
port = int(os.environ.get('UPDATES_PORT', '50180'))
state = os.environ.get('UPDATES_STATE') or None
m.mod('updates')(state_path=state).serve(port=port, host='0.0.0.0', background=False)
