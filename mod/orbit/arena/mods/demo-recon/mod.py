"""demo-recon — a python game in the arena.

Reconstruct 3 functions from demo-repo (/tmp/demo-repo), graded against what they really return.
...
below, which are a thin face over two things the arena already serves —
    ...
    its own MCP server  /m/demo-recon/mcp — this module alone, as a server
