"""blotto — a python game in the arena.

Colonel Blotto — both seats allocate at once and neither sees the other first. The simultaneous, hidden-information case of the class ABI.
...
below, which are a thin face over two things the arena already serves —
    ...
    its own MCP server  /m/blotto/mcp — this module alone, as a server
