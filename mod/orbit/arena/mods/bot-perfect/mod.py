"""bot-perfect — a rust agent in the arena.

Perfect Nim by arithmetic — leaves a multiple of four and never loses from a won position. The reference opponent.
...
below, which are a thin face over two things the arena already serves —
    ...
    its own MCP server  /m/bot-perfect/mcp — this module alone, as a server
