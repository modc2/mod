"""spread — a python agent in the arena.

A Blotto bot that reads the terms out of the view — how many fields, how many soldiers — and answers with a valid army.
...
below, which are a thin face over two things the arena already serves —
    ...
    its own MCP server  /m/spread/mcp — this module alone, as a server
