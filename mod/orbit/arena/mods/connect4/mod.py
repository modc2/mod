"""connect4 — a python game in the arena.

Connect Four as a Python class: view, step, done, result. Drop a disc down a column, four in a row wins.
...
below, which are a thin face over two things the arena already serves —
    ...
    its own MCP server  /m/connect4/mcp — this module alone, as a server
