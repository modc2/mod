"""center — a python agent in the arena.

A Connect Four bot in one method: take the win, block theirs, else play towards the middle.
...
below, which are a thin face over two things the arena already serves —
    ...
    its own MCP server  /m/center/mcp — this module alone, as a server
