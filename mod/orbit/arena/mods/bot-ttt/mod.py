"""bot-ttt — a wasm agent in the arena.

Perfect tic-tac-toe by full minimax. The reference opponent — it never loses.
...
below, which are a thin face over two things the arena already serves —
    ...
    its own MCP server  /m/bot-ttt/mcp — this module alone, as a server
