/* /openhouse/paper/<slug> — one whitepaper section, one page.

   Slugs come from SECTIONS in lib/whitepaper.ts, so the six pages are
   generated from the same copy the home page scrolls. Add a section there
   and its page exists; there is nothing to wire up here. */
...
export default function PaperSectionPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="relative grain vignette min-h-screen">
      ...
      <PaperNav here={section.slug} />

      <article className="relative z-10 max-w-3xl mx-auto px-5 md:px-8">
        <header className="pt-20 pb-10 md:pt-28 md:pb-14">
