...
installed, any launcher build-fork runs itself — the generic backend's `start.sh`,
...
```
build-fork/
├── src/mod.py           Python SDK (34 methods, auto-starts API)
