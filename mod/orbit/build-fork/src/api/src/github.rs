...
//!   ~/.mod/build-fork/github/<module>.json   — repo, token, branch allowlist
//!   ~/.mod/build-fork/github/work/<module>/  — working clone used for push/merge
//!
...
pub fn github_dir() -> PathBuf {
    ...
    PathBuf::from(home).join(".mod").join("build-fork").join("github")
}
