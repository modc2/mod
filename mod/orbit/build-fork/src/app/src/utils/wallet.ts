...
const STORAGE_KEY = "buildfork_wallet_history";
 ...
 *
 * navigator.clipboard is undefined on plain-http origins (the module hit
 * directly at http://host:8895 instead of through the https gateway), where a
 * copy button that silently does nothing is worse than no button — so fall
...
const CUSTOM_TOKENS_KEY = "buildfork_custom_tokens";
